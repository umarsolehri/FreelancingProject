...
namespace FFYP
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            {
                From = new MailAddress("demomailpro@gmail.com", "Free-Lancing"),
                Subject = "Free-Lancing",
                IsBodyHtml = true,
                Body = message.Body
            };
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<FFYPContext>()));
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole>
    {
        ...
        {
            var store = new RoleStore<IdentityRole>(context.Get<FFYPContext>());
